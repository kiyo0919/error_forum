...
ActiveRecord::Schema.define(version: 2022_04_20_113700) do
  ...
  create_table "error_comments", charset: "utf8mb4", force: :cascade do |t|
    t.text "comment"
    t.integer "error_id"
    t.integer "mentor_id"
  ...
  create_table "mentors", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "used_technologies", charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
